...
public class ServiceImplSocio implements ServiceSocio<DtoSocio>{
    ...
    @Override
    public List<DtoSocio> getAll() throws EmptyDataException, NoAuthorizedException {
    ...
    @Override
    public ResponseEntity<String> create(DtoSocio dto, Long idDirector, Long idSede) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
